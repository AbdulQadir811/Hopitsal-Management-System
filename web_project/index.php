						...
						<div class="row ml-0 w-100">
							<div class="col-lg-12 pr-0">
								<ul class="nav navbar-nav center_nav pull-right">
									...
									<li class="nav-item ">
										<a class="nav-link" href="blood_donor_reg_form.php">Register Blood Donor</a>
									</li>
									<li class="nav-item submenu dropdown">
										<a href="patient_login.php" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Login</a>
										<ul class="dropdown-menu">
											<li class="nav-item">
												<a class="nav-link" href="patient_login.php">Patient</a>
											</li>
											<li class="nav-item">
												<a class="nav-link" href="dr_login.php">Doctor</a>
											</li>
										</ul>
									</li>
									<li class="nav-item submenu dropdown">
										...
										<ul class="dropdown-menu">
											...
											<li class="nav-item">
												<a class="nav-link" href="dr_signup.php">Doctor</a>
											</li>
										</ul>
									</li>
									<li class="nav-item">
