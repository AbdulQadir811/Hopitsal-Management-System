    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Blood Donor Registration</h2>
                    <form method="post" action="blood_donor_reg.php" >
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="date" name="birthday" placeholder="birthday" required>
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
