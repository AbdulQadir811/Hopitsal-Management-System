...
$conn = mysqli_connect("localhost", "root", "", "hospital");
  ...
  $id = $_SESSION['id'];
  $sql = "SELECT id, email, name, blood_group,pass,age,contact_no,address,birth_date,sex,description FROM patient where id = $id";
...
?>
<a href="patient_update.php">UPDATE</a>
</table>
  </div>
